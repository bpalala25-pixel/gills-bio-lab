    ...
    <div style={{ backgroundColor: "#0d1117", minHeight: "100vh" }}>
      <div style={{ background: "linear-gradient(135deg, #161b22, #0d1117)", borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold text-white mt-2 mb-3">Refund &amp; Shipping Policy</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10">
        ...
        <div className="p-5 rounded-xl text-sm"
          ...
          <Link href="/legal/research-use" style={{ color: "#2dd4bf" }} className="underline">Research Use Policy</Link>
          {" "}and{" "}
        ...
        <Section title="Refunds &amp; Returns">
          ...
          <p className="mt-3"><strong className="text-white">Eligible for refund or replacement:</strong></p>
          <ul>
            <li>Vials damaged in transit</li>
            <li>Incorrect product shipped</li>
            <li>Confirmed quality or integrity concerns</li>
          </ul>
          <p className="mt-3"><strong className="text-white">Not eligible for return:</strong></p>
          <ul>
