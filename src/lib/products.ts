...
export const products: Product[] = [
  ...
  },
  {
    ...
    code: "TB-500",
    category: "Peptides",
    tagline: "Thymosin beta-4 synthetic analogue research chemical for cytoskeletal studies.",
    description:
      "TB-500 is a synthetic analogue of Thymosin Beta-4, supplied by Gills Bio Lab as a research chemical for laboratory use only. Suitable for in vitro research into actin binding, cellular migration pathways, and cytoskeletal dynamics in controlled laboratory settings.",
    quantity: "10 mg / vial",
    form: "Lyophilized powder",
    purity: "≥ 98%",
    storage: "-20°C in a dry, dark location",
