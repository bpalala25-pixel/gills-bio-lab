...
export const products: Product[] = [
  ...
  },
  {
    ...
    priceFrom: 30,
    prices: [
      { qty: "30 mg × 1", price: 30 },
      { qty: "50 mg × 1", price: 50 },
      { qty: "100 mg × 1", price: 100 },
    ],
    inStock: true,
    featured: true,
    labFavorite: true,
  ...
  },
  {
    ...
    handling: "Use appropriate personal protective equipment and follow institutional safety protocols.",
    priceFrom: 19.99,
    prices: [{ qty: "30 mL × 1", price: 19.99 }],
    inStock: true,
    featured: false,
  },
  {
    ...
    priceFrom: 90,
    prices: [
      { qty: "90 mg × 1", price: 90 },
      { qty: "150 mg × 1", price: 150 },
      { qty: "180 mg × 1", price: 180 },
    ],
    inStock: true,
    featured: true,
    badge: "New",
